 ...
 * {@link #onBindViewHolderCursor(CursorViewHolder, Cursor)}.
 * <p>
 ...
 */
public abstract class RecyclerCursorAdapter<VH extends CursorViewHolder>
    ...
    private DataSetChangeStrategy mDataSetChangeStrategy;
    ...
    void init(Cursor c) {
        ...
        mDataSetChangeStrategy = new DataSetChangeStrategyNormal(this);
    }

    /**
     * This method will move the Cursor to the correct position and call
     * {@link #onBindViewHolderCursor(CursorViewHolder,
     * Cursor)}.
     *
    ...
    public void onBindViewHolder(VH holder, int i) {
        ...
        holder.setRecyclerView(mRecyclerView);
    }
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            notifyDataSetChanged(oldCursor, newCursor);
        } else {
            mRowIDColumn = -1;
            mDataValid = false;
    ...
    public void setChangeProjection(String... projection) {
        mDataSetChangeStrategy.setChangeProjection(projection);
    }

    public void setDataSetChangeStrategy(DataSetChangeStrategy dataSetChangeStrategy) {
        mDataSetChangeStrategy = dataSetChangeStrategy;
    }

    private void notifyDataSetChanged(Cursor oldCursor, Cursor newCursor) {
        if (oldCursor == null || newCursor == null || oldCursor.isClosed() || newCursor.isClosed()) {
            notifyDataSetChanged();
            return;
        }
        mDataSetChangeStrategy.onCalculateDataSetChanges(oldCursor, newCursor);
    }
